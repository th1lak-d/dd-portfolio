    ...
    <section className="border-b border-line dark:border-line-d">
      <div className="max-w-5xl mx-auto px-6 md:px-10 py-24">
        <Reveal>
          ...
          <div className="border border-dashed border-line dark:border-line-d rounded-lg p-8 md:p-10 bg-panel/30 dark:bg-panel-d/30">
            <div className="flex items-center gap-2 font-mono text-xs text-muted dark:text-muted-d mb-4">
            ...
            <h3 className="font-display font-medium text-2xl md:text-3xl text-ink dark:text-ink-d">
              Next build, in the works.
            </h3>
            <p className="mt-3 text-muted dark:text-muted-d max-w-xl text-sm md:text-base leading-relaxed">
